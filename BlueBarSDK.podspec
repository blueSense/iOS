...
Pod::Spec.new do |s|
  ...
  s.author             = { "Blue Sense Networks" => "contact@bluesensenetworks.com" }

  # Or just: s.author    = "Vladimir Petrov"
  # s.authors            = { "Vladimir Petrov" => "vlad@bluesensenetworks.com" }

  s.social_media_url   = "http://twitter.com/BlueSenseNet"
  ...
  s.source       = { :git => "https://github.com/BlueSenseNetworks/iOS.git", :tag => "0.5" }
