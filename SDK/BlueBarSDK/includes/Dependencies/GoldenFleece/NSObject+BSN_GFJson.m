...
@implementation NSObject (BSN_GFJson)
...
- (id)initWithDateString:(NSString*)dateString {
    return [[BSN_GFDateFormatter sharedInstance] dateFromString:dateString];
}
...
- (id)jsonObject {
    if ([self isKindOfClass:[NSArray class]]) {
        ...
        return [[BSN_GFDateFormatter sharedInstance] stringFromDate:(NSDate*)self];
    } else {
