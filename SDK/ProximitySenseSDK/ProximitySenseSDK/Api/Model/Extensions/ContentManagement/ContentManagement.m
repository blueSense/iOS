...
{
    [[ProximitySenseSDK Api] requestForEndpoint:@"extensions/ContentManagement/publications" withObject:getPublicationsRequest withResultObject:[Publication alloc] onCompletion:^(id result, NSError *connectionError) {
        if (onCompletion != nil)
